...
import '../widgets/plant_chip.dart';
import '../../shared/widgets/empty_chart_state.dart';
import '../../shared/widgets/scrollable_chart.dart'; // ✅ new import
...
class _ArchivedTrendsScreenState extends State<ArchivedTrendsScreen> {
  ...
  Future<void> _onShowData() async {
    ...
    if (_selectedPlant == null) {
      showToast(
          message: 'Please select a plant first',
    ...
    if (cubit.archiveTrend.isEmpty ||
      ...
      showToast(message: "No data found for this period", state: ToastStates.WARNING);
                          ...
                          children: [
                            ...
                            if (_selectedMetrics.isNotEmpty)
                              Wrap(
                                ...
                                children: _selectedMetrics
                                    .map((metric) => MetricChip(label: metric))
                                    .toList(),
                              ),
                            ...
                            Container(
                              ...
                              child: _showChart
                                ...
                                timeAxis: AppCubit.get(context).archiveTimeAxis,
                              )
  ...
  Widget _buildMetricSelector() => Container(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(14),
          border: Border.all(
            color: const Color(0xFF7B8C5F).withValues(alpha: 0.3),
            width: 1.3,
          ),
        ),
