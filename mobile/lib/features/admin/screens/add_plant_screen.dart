...
class AddPlantScreen extends StatefulWidget {
  ...
  const AddPlantScreen({super.key, required this.greenhouseName, required this.greenhouseID});
...
class _AddPlantScreenState extends State<AddPlantScreen> {
  ...
  void _addPlant() {
    ...
    AppCubit.get(context).addPlant(context, _nameController.text, selectedPlantType, widget.greenhouseID, _locationController.text, imageToUpload);
  }
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              const Text(
                                'Add a new plant to this greenhouse.',
                                style: TextStyle(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<PlantTypeModel>(
                          value: _plantType,
                          ...
                          items: AppCubit.get(context).plantTypes.map((plant) {
                            return DropdownMenuItem<PlantTypeModel>(
                              value: plant,
                              child: Text(plant.name!), // <-- adjust to your actual field
                            );
                          }).toList(),
                        ...
                        // 🖼 Image Picker Field with Remove Option
                        const Text(
                          'Plant Image',
                          style: TextStyle(
                            color: darkGreen,
