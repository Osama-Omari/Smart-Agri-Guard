...
class AppCubit extends Cubit<AppStates> {
  ...
  Future<void> login(context, String userName, String password) async {
    ...
    await DioHelper.postDataWithoutData(url: AuthEndPoints.login, data: data)
      ...
      await storage.write(
          key: "userName", value: loginResponse!.user!.username);
      await storage.write(
          key: "fullName", value: loginResponse!.user!.fullName);
      await storage.write(
          key: "roleName", value: loginResponse!.user!.roleName);
      ...
      if (loginResponse!.user!.roleName == 'Farmer') {
        ...
        navigateTo(context,
            AssignedPlantsScreen(farmerName: loginResponse!.user!.fullName!));
  ...
  Future<void> logout(context) async {
    ...
    await DioHelper.postData(url: AuthEndPoints.logout, data: data)
        .then((value) async {
      emit(LogoutSuccessState());
      print(
          'was token: ${await storage.read(key: "token")}\n username: ${await storage.read(key: "username")}');
      await storage.deleteAll();
      print(
          'Then token: ${await storage.read(key: "token")}\n username: ${await storage.read(key: "username")}');
  ...
  Future<void> changeUserInfo(newFullName, context) async {
    ...
    await DioHelper.putData(url: UserEndPoints.changeUserInfo, data: data)
        .then((value) async {
      await storage.write(key: "fullName", value: newFullName);
      globalFullName = newFullName!;
      showToast(
          message: 'Info Updated Successfully', state: ToastStates.SUCCESS);
  ...
  Future<void> changePassword(context, currentPassword, newPassword) async {
    ...
    await DioHelper.putData(url: UserEndPoints.changePassword, data: data)
        .then((value) {
      showToast(
...
// Start of Greenhouse Management
  ...
  Future<void> getAllGreenhouses() async {
    ...
    allGreenhouse.clear();
    await DioHelper.getData(url: GreenhouseEndPoints.getAllGreenhouses)
        .then((value) {
  ...
  Future<void> updateGreenhouse(context, id, name, location, imageFile) async {
    ...
    await DioHelper.putDataFromForm(
            url: GreenhouseEndPoints.updateGreenhouse(id), data: data)
        .then((value) {
  ...
  Future<void> deleteGreenhouse(id) async {
    ...
    print(id);
    await DioHelper.deleteData(url: GreenhouseEndPoints.deleteGreenhouse(id))
        .then((value) {
  ...
  Future<void> addGreenhouse(context, name, location, imageFile) async {
    ...
    await DioHelper.postDataFromForm(
            url: GreenhouseEndPoints.addGreenhouse, data: data)
        .then((value) {
      emit(AddGreenhouseSuccessState());
      showToast(
          message: 'You Have Added a New Greenhouse Successfully',
          state: ToastStates.SUCCESS);
      back(context);
    }).catchError((error) {
  ...
  Future<void> getGreenhouseManager(greenhouseID) async {
    ...
    await DioHelper.getData(
            url: GreenhouseEndPoints.getGreenhouseManager(greenhouseID))
        .then((value) {
  ...
  Future<void> unAssignGreenhouseManager(greenhouseID) async {
    ...
    await DioHelper.patchDataWithoutData(
            url: GreenhouseEndPoints.unAssignManager(greenhouseID))
        .then((value) {
      manager = null;
  ...
  Future<void> assignManager(context, managerID, greenhouseID) async {
    ...
    await DioHelper.patchDataWithoutData(
            url: GreenhouseEndPoints.assignManager(managerID, greenhouseID))
        .then((value) {
      manager = managers.firstWhere((m) => m.id == managerID);
      emit(AssignManagerSuccessState());
      showToast(
          message: 'Manager Has Been Assigned Successfully!',
          state: ToastStates.SUCCESS);
    }).catchError((error) {
  ...
  Future<void> getAllPlants(greenhouseID) async {
    ...
    plants.clear();
    await DioHelper.getData(url: PlantEndPoints.getAllPlants(greenhouseID))
        .then((value) {
  ...
  Future<void> deletePlant(plantID) async {
    ...
    await DioHelper.deleteData(url: PlantEndPoints.deletePlant(plantID))
      ...
      showToast(
          message: 'You have deleted the plant successfully',
          state: ToastStates.SUCCESS);
    }).catchError((error) {
  ...
  Future<void> getPlantTypes() async {
    ...
    plantTypes.clear();
    await DioHelper.getData(url: PlantTypeEndPoints.getAllPlantTypes)
        .then((value) {
      final List data = value!.data as List;
      plantTypes = data
  ...
  Future<void> addPlant(context, plantName, plantTypeID, greenhouseID, location,
      imagePath) async {
    ...
    await DioHelper.postDataFromForm(
            url: PlantEndPoints.addPlant(greenhouseID), data: data)
        .then((value) {
      emit(AddPlantSuccessState());
      showToast(
          message: 'You Have Added a New Plant Successfully',
          state: ToastStates.SUCCESS);
      back(context);
    }).catchError((error) {
  ...
  Future<void> updatePlant(
      context, plantName, plantTypeID, plantID, location, imagePath) async {
    ...
    await DioHelper.putDataFromForm(
            url: PlantEndPoints.updatePlant(plantID), data: data)
        .then((value) {
      emit(UpdatePlantSuccessState());
      showToast(
          message: 'You Have Updated The Plant Successfully',
          state: ToastStates.SUCCESS);
      back(context);
    }).catchError((error) {
...
// Start of Managers Management
  ...
  Future<void> deleteManager(managerID) async {
    ...
    await DioHelper.deleteData(url: UserEndPoints.deleteManager(managerID))
        .then((value) {
      emit(DeleteManagerSuccessState());
      showToast(
          message: 'You Have Deleted The Manager Successfully',
          state: ToastStates.SUCCESS);
    }).catchError((error) {
  ...
  Future<void> getGreenhousesWithoutManagers() async {
    ...
    await DioHelper.getData(
            url: GreenhouseEndPoints.getAllGreenhousesWithoutManager)
        .then((value) {
      emit(GetGreenhousesWithoutManagerSuccessState());
      List data = value!.data;
      greenhousesWithoutManager =
  ...
  Future<void> addManager(
      context, fullName, username, password, assignedGreenhouses) async {
    ...
    await DioHelper.postData(url: AuthEndPoints.registerManager, data: data)
        .then((value) {
      emit(AddManagerSuccessState());
      showToast(
          message: 'You Have Added The Manager Successfully',
          state: ToastStates.SUCCESS);
      back(context);
    }).catchError((error) {
...
// Start of PlantType Management
  Future<void> updatePlantType(
      context, plantTypeID, plantName, plantDescription) async {
    ...
    await DioHelper.putData(
            url: PlantTypeEndPoints.updatePlantType(plantTypeID), data: data)
        .then((value) {
      emit(UpdatePlantTypeSuccessState());
      showToast(
          message: 'PlantType Updated Successfully',
          state: ToastStates.SUCCESS);
      back(context);
    }).catchError((error) {
  ...
  Future<void> addPlantType(context, plantName, plantDescription) async {
    ...
    await DioHelper.postData(url: PlantTypeEndPoints.addPlantType, data: data)
        .then((value) {
      emit(AddPlantTypeSuccessState());
      showToast(
          message: 'PlantType Added Successfully', state: ToastStates.SUCCESS);
      back(context);
    }).catchError((error) {
  ...
  Future<void> deletePlantType(plantTypeID) async {
    ...
    await DioHelper.deleteData(
            url: PlantTypeEndPoints.deletePlantType(plantTypeID))
        .then((value) {
...
// Start of Farmer Management
  ...
  Future<void> getPlantsWithMetrics(BuildContext context) async {
    ...
    try {
      final value =
          await DioHelper.getData(url: FarmerPlantEndPoints.getFarmerPlants);
      final List data = value!.data;
      print(value);
      // 1. Map the JSON to your model list
      plantsWithMetrics = data
          .map(
              (e) => PlantsWithMetricsModel.fromJson(e as Map<String, dynamic>))
          .toList();
  ...
  Future<void> getSensorTrend(String plantID, String startDate, String endDate,
      List<String> selectedMetrics) async {
    ...
    sensorTrend.clear();
    timeAxis.clear();
    await DioHelper.getDataWithQueryParameters(
      url: SensorDataEndPoints.getTrendSensorData,
      data: body,
    ).then((value) {
      ...
      if (model.readings != null) {
        timeAxis = model.readings!
            .where((e) => e.timestamp != null)
            .map((e) => DateTime.parse(e.timestamp.toString()!))
            .toList();
      }
...
// Start of Manager Management
  ...
  Future<void> getAssignedGreenhouses() async {
    ...
    await DioHelper.getData(url: GreenhouseEndPoints.getAssignedGreenhouses)
        .then((value) {
  ...
  Future<void> getGreenhousePlantsWithMetrics(
      BuildContext context, greenhouseID) async {
    emit(GetGreenhousePlantsWithMetricsLoadingState());
    greenhousePlantsWithMetrics.clear();

    try {
      final value = await DioHelper.getData(
          url: PlantEndPoints.getGreenhousePlants(greenhouseID));
      final List data = value!.data;

      // 1. Parse the data
      greenhousePlantsWithMetrics = data
          .map(
              (e) => PlantsWithMetricsModel.fromJson(e as Map<String, dynamic>))
          .toList();
  ...
  Future<void> deleteFarmer(farmerID) async {
    ...
    print(farmerID);
    await DioHelper.deleteData(url: UserEndPoints.deleteFarmer(farmerID))
        .then((value) {
      emit(DeleteFarmerSuccessState());
      showToast(
          message: 'You Have Deleted The Farmer Successfully',
          state: ToastStates.SUCCESS);
    }).catchError((error) {
  ...
  Future<void> registerFarmer(context, fullName, username, password,
      assignedPlants, greenhouseID) async {
    ...
    await DioHelper.postData(
            url: AuthEndPoints.registerFarmer(greenhouseID), data: data)
        .then((value) {
      emit(RegisterFarmerSuccessState());
      showToast(
          message: 'You Have Added The Farmer Successfully',
          state: ToastStates.SUCCESS);
      back(context);
    }).catchError((error) {
  ...
  static String? token;
  Future<void> generateReport(greenhouseID, plantIDs, startDate, endDate,
      sensorTypes, reportFormat) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (response.data == null || response.data.isEmpty) {
          throw Exception(
              "Server returned success (200) but the report file data was empty.");
        }
        ...
        String fileName =
            "report.${reportFormat.toLowerCase()}"; // Default filename
        ...
        if (contentDisposition != null) {
          ...
          if (complexMatch != null) {
            ...
            fileName =
                Uri.decodeComponent(encodedFileName.replaceAll('"', '').trim());
          } else {
        ...
        fileName =
            p.basename(fileName); // Prevents security issues and path problems
        ...
        throw Exception(
            "Server responded with unexpected status code: ${response.statusCode}");
      }
    } catch (error) {
      ...
      showToast(
          message: 'Report generation failed. Details: ${error.toString()}',
  ...
  Future<void> getArchiveTrend(String plantID, String startDate, String endDate,
      List<String> selectedMetrics) async {
    ...
    await DioHelper.getDataWithQueryParameters(
      url: SensorDataEndPoints.getArchiveTrendSensorData,
      data: body,
    ).then((value) {
      final model = SensorDataModel.fromJson(
        value!.data as Map<String, dynamic>,
      ...
      if (model.readings != null) {
        archiveTimeAxis = model.readings!
            .where((e) => e.timestamp != null)
            .map((e) => DateTime.parse(e.timestamp.toString()!))
            .toList();
      }
  ...
  Future<void> unAssignFarmer(plantID, farmerID) async {
    ...
    await DioHelper.deleteData(
            url: FarmerPlantEndPoints.unAssignFarmer(plantID, farmerID))
        .then((value) {
      emit(UnAssignFarmerSuccessState());
      showToast(
          message: 'Farmer UnAssigned Successfully',
          state: ToastStates.SUCCESS);
    }).catchError((error) {
  ...
  Future<void> assignFarmer(plantID, farmerIDs) async {
    ...
    await DioHelper.postData(
            url: FarmerPlantEndPoints.assignFarmer(plantID), data: data)
        .then((value) {
      emit(AssignFarmerSuccessState());
      showToast(
          message: 'Farmer Assigned Successfully', state: ToastStates.SUCCESS);
    }).catchError((error) {
  ...
  Future<void> getPlantNotifications(plantID) async {
    ...
    await DioHelper.getData(
            url: NotificationEndPoints.getPlantNotifications(plantID))
        .then((value) {
      emit(GetPlantNotificationsSuccessState());
      List data = value!.data;
      print(value);
      allPlantNotifications =
          data.map((e) => PlantNotifications.fromJson(e)).toList();
  ...
  Future<void> markPlantNotificationAsRead(
      List<String> notificationsIDs) async {
    emit(MarkPlantNotificationAsReadLoadingState());
    await DioHelper.patchDataList(
            url: NotificationEndPoints.markPlantNotificationAsRead,
  ...
  Future<void> getGreenhouseNotifications(String greenhouseID) async {
    ...
    await DioHelper.getData(
            url: NotificationEndPoints.getGreenhouseNotifications(greenhouseID))
        .then((value) {
      emit(GetGreenhouseNotificationsSuccessState());
      List data = value!.data;
      allGreenhouseNotifications =
          data.map((e) => GreenhouseNotifications.fromJson(e)).toList();
  ...
  Future<void> markGreenhouseNotificationAsRead(
      List<String> notificationsIDs) async {
    emit(MarkGreenhouseNotificationAsReadLoadingState());
    await DioHelper.patchDataList(
            url: NotificationEndPoints.markGreenhouseNotificationAsRead,
            data: notificationsIDs)
        .then((value) {
  ...
  Future<void> getGreenhousesNotifications() async {
    ...
    await DioHelper.getData(
            url: NotificationEndPoints.getGreenhousesNotifications)
        .then((value) {
      emit(GetGreenhousesNotificationsSuccessState());
      List data = value!.data;
      greenhousesNotifications =
          data.map((e) => GreenhouseNotifications.fromJson(e)).toList();
  ...
  Future<void> getPlantSchedules(String plantId) async {
    ...
    schedules.clear();
    await DioHelper.getData(url: PlantEndPoints.getPlantSchedules(plantId))
        .then((value) {
